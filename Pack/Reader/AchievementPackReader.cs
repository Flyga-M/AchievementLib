...
namespace AchievementLib.Pack.Reader
{
    public static class AchievementPackReader
    {
        ...
        public static V1.Models.AchievementData DeserializeV1FromJson(Stream jsonStream, V1.JSON.ActionConverter actionConverter = null)
        {
        ...
        public static V1.Models.AchievementData DeserializeV1FromJson(string jsonContents, V1.JSON.ActionConverter actionConverter = null)
        {
            JsonSerializerSettings settings = new JsonSerializerSettings()
            {
                Converters = { actionConverter ?? V1.JSON.ActionConverter.Default }
